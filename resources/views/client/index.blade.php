                    ...
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="client/img/best-product-1.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Du Lịch</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="client/img/best-product-3.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="{{ asset('client/img/'. $m -> img) }}" class="img-fluid w-100 rounded-top"
                                                    alt="">
                                            </div>
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                @foreach ($tinDL as $dl)
                    <div class="border border-primary rounded position-relative vesitable-item">
                        ...
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Du Lịch</div>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="position-relative">
                        <img src="{{ asset('client/img/'. $top1 ->img) }}" class="img-fluid w-100 rounded" alt="">
                    </div>
                </div>
                {{-- @endforeach --}}
            </div>

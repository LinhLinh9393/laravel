                            ...
                            <form action="{{ route('search') }}" method="get">
                                <div class="position-relative mx-auto">
                                    <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill"
                                        type="text" name="key" placeholder="Search" name="key">
                                    <button type="submit"
                                ...
                                @foreach ($danhmuc as $dm)
                                    <li class="nav-item">
                                        <a class="d-flex m-2 py-2 bg-light rounded-pill active text-dark text-center"
                                            href="{{ route('content', $dm->id) }}"
                                            style="width: 130px; flex-flow: column;"> {{ $dm->title }}
                                        </a>
                                    </li>
                                @endforeach
                            ...
                            <div class="row g-4">
                                    ...
                                    @foreach ($new as $m)
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="rounded me-4" style="width: 300px; height: 100px;">
                                                <img src="{{ Storage::url($m->img) }}" class="img-fluid rounded"
                                                    alt="">
                                            </div>
                                            <div>
                                                <p class="text-danger "><a href="{{ route('chiTiet', $m->id) }}">
                                                        {{ $m->title }}</a></p>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="col-lg-12">
                                    <div class="position-relative">
                                        <img src="{{ asset('client/img/banner-fruits.jpg') }}"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @foreach ($top5 as $tp)
                                        <div class="d-flex align-items-center justify-content-start">
                                            <div class="rounded me-4" style="width: 300px; height: 100px;">
                                                <img src="{{ Storage::url($tp->img) }}" class="img-fluid rounded"
                                                    alt="">
                                            </div>
                                            <div>
                                                <p class="text-danger "><a href="{{ route('chiTiet', $tp->id) }}">
                                                        {{ $tp->title }}</a></p>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            <div class="detail__comment notPopUp box-comment-v2">
                                <div class="box-comment ykcb" id="ykcb-form">
                                    ...
                                    <form action="{{ route('comments.store', $tin->id) }}" method="post">
                                        ...
                                        <div class="t-content">
                                            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Nhập bình luận" rows="3"
                                        ...
                                        @foreach ($binhluan as $bl)
                                            <div class="row form-comment mt-3 ms-3">
                                                ...
                                                <div class="col-lg-3">
                                                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseExample">Xem câu trl</button>
                                                    <button class="btn btn-warning" type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseExample" aria-expanded="false"
                                                        aria-controls="collapseExample">Trả lời</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="collapse mt-4 ms-5" id="collapseExample">
                                                ...
                                                <form action="{{ route('comments.store', $tin->id) }}" method="post">
                                                    ...
                                                    <div class="box-bottom">
                                                        <button type="submit" class="btn btn-success">Gửi bình
                                                            luận</button>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        @foreach ($tinDL as $dl)
                                            <div class="border border-primary rounded position-relative vesitable-item">
                                                <div class="vesitable-img">
                                                    <img src="{{ Storage::url($dl->img) }}"
                                                        class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                                    style="top: 10px; right: 10px;">Khác</div>
